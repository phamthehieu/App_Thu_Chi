...
class AccountSelectedAdapter(
    private val accounts: List<AccountIconFormat>,
    private val onItemClick: (AccountIconFormat) -> Unit
) : RecyclerView.Adapter<AccountSelectedAdapter.AccountViewHolder>() {

    private var selectedPosition: Int = RecyclerView.NO_POSITION

    @SuppressLint("NotifyDataSetChanged")
    fun setSelectedAccount(account: AccountIconFormat?) {
        selectedPosition = accounts.indexOfFirst { it.id == account?.id }
    ...
    inner class AccountViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        private val selectedItemIV: ImageView = itemView.findViewById(R.id.selectedItemIV)
        ...
        fun bind(account: AccountIconFormat, position: Int) {
            ...
            selectedItemIV.visibility = if (adapterPosition == selectedPosition) View.VISIBLE else View.GONE
            selectedItemIV.setColorFilter(ContextCompat.getColor(itemView.context, R.color.yellow))
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AccountViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_layout_account_selected, parent, false)
