...
import com.example.myapplication.databinding.FragmentExpenseSettingBinding
import com.example.myapplication.entity.Category
import com.example.myapplication.viewModel.CategoryViewModel
import com.example.myapplication.viewModel.CategoryViewModelFactory

class ExpenseSettingFragment : Fragment(), SettingCategoryAdapter.OnItemClickListener {

    private lateinit var binding: FragmentExpenseSettingBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentExpenseSettingBinding.inflate(inflater, container, false)
        binding.recyclerViewExpenseSetting.layoutManager = LinearLayoutManager(requireContext())
        ...
        binding.addCategoryExpenseBtn.setOnClickListener {
    ...
    private fun updateRecyclerView(combinedList: List<CombinedCategoryIcon>) {
        ...
        binding.recyclerViewExpenseSetting.adapter = settingCategoryActivity
    }
