...
class TotalIncomeChartFragment : Fragment() {

    private lateinit var binding: FragmentTotalIncomeChartBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentTotalIncomeChartBinding.inflate(inflater, container, false)
